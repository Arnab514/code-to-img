    ...
    <main className="h-[100vh] flex flex-col items-center justify-between">
      ...
      <header className="mt-6 w-[940px] flex gap-6 p-5 fixed top-0 left-1/2 translate-x-[-50%] z-10 bg-[#191919] rounded border border-[#3C3C3C] shadow-md">
        ...
        <div className="export-btn self-center ml-auto">
          <button className="flex items-center gap-2  bg-blue-400 py-2 px-3 text-blue-400 text-sm rounded-md font-medium bg-opacity-10 hover:bg-opacity-80 hover:text-slate-50 ease-in-out transition-all duration-300"
          onClick={exportPng}>
            Export png 
            <ArrowDownToLine />
          </button>
